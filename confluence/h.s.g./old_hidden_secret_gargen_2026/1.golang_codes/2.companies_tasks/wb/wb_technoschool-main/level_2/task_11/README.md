...
Запуск/использование: импортируйте пакет `task11` и вызовите `FindAnagramSets(words []string) map[string][]string`.
Вход — срез слов; выход — map с группами анаграмм, как описано выше.