...
go run sol.go -depth 2 -out site -parallel 8 https://example.com
Сохранит сайт в каталог out, рекурсивно проходя ссылки в том же домене до глубины depth; ресурсы (href/src) переписываются на локальные пути.
Требования
